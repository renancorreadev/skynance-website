    ...
    return (
      <Container id="about">
        <div className="about-text">
          ...
          <div className="hard-skills">
            ...
            <div className="blockchain-block">
              ...
              <div className="hability">
                <ScrollAnimation animateIn="fadeInUp" delay={0.19 * 1000}>
                <img src="/images/truffle.svg" alt="" title="Truffle Development Kit" />
                  <ProgressBar bgcolor="green" completed={70}/>
                </ScrollAnimation>
              </div>
              ...
              <div className="hability">
                <ScrollAnimation animateIn="fadeInUp" delay={0.19 * 1000}>
                <img src="/images/thegraph.svg" alt="" title="The Graph" />
              ...
              <div className="hability">
                <ScrollAnimation animateIn="fadeInUp" delay={0.19 * 1000}>
                    <div className="vtex-spanc">
                      <img  src="/images/vtex.png" title="Vtex IO" alt="vtex"/>
                      <span style={{
                        fontSize: 20,
                        fontWeight: 600,
                        color: 'red',
        ...
        <div className="about-image">
          ...
          <img src="/images/foto.jpeg" alt="Renan Cesar" />
          </ScrollAnimation>
        </div>
      </Container>
    )
