          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/miriade.png" alt="project" />
              </div>
              <footer>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/yamamay.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>Vtex IO</li>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/carpisa.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>Vtex IO</li>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/canali.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>Vtex IO</li>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/v73.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>Vtex IO</li>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/arteni.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>Vtex IO</li>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                <h3>Carpisa - Europe</h3>
                <p>
                Outro projeto desenvolvido para a mesma equipe que a Yamamay, as particularidades deste projeto se baseiam nas da Yamamay, usamos algumos recursos extensiveis para aprimorar e melhorar a expêriencia do usuário no admin.
                </p>
