          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/blockimob.png" alt="project" />
              </div>
              <footer>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/marketplace.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>React</li>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/farm.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>React</li>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/stake.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>React</li>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/Lottery.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>React</li>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/primbank.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>React</li>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/passive.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>React</li>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/course.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>React</li>
          ...
          <ScrollAnimation animateIn="flipInX">
            <div className="project">
              ...
              <div className="body">
                ...
                <img className="image-project" src="/images/portfolios/event.png" alt="project" />
              </div>
              <footer>
                <ul className="tech-list">
                  <li>React</li>
